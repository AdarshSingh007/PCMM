      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../../Homepage/indes.php">Home PMS</a></li>
        ...
        <div class="templatemo-content-container">
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2022-24 PMS 
            | Developed by <a href="http://wafferdev,wordpress.com" target="_parent">Ideal Developers</a></p>
          </footer>
        </div>
      </div>
    </div> 
