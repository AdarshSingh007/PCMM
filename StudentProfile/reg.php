...
$Answer = $_POST['Answer'];
 ...
 $check = mysqli_query($connect,"SELECT * FROM signup WHERE USN='".$USN."'") or die("Check Query");
 if(mysqli_num_rows($check) == 0) 
 {
  if($repassword == $password)
  {
    ...
    if($query = mysqli_query($connect,"INSERT INTO signup(Fullname, USN ,PASSWORD,Email,Question,Answer) VALUES ('$Name', '$USN', '$password','$Email','$Question','$Answer')"))
    {
