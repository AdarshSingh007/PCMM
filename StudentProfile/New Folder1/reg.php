<?php
   $connect = mysql_connect("localhost", "root", "place"); // Establishing Connection with Server
   mysql_select_db("place") or die("Cant Connect to database"); // Selecting Database from Server
