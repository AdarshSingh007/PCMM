...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">BIET <i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>
						Bansal Institute of Engineering & Technology is managed by Bansal Educational
						Trust founded in the year 2007 and registered under the Societies Registration
						Act of 1860 with an aim of providing quality technical education.
						The Institute is affiliated to U.P. Technical University, 
						Lucknow and approved by AICTE,.Ministry of HRD, Govt of India.
                        The Institute is located on the main 120ft. NH-24, Sitapur road and is situated 
						at a distance of only 3 Kms from U.P. Technical University and behind the well known
						Sewa Hospital and the Brij Ki Rasoi. Thus, being away from the crowd of the city the
						college is situated in a spacious lush green campus having natural environment
						conducive for well planned studies.
                        “TECHNOLOGY IS OUR RELIGION AND QUALITY IS OUR MOTTO” — is the driving force motivating the 
						society to work with total commitment towards excellence in every endeavor. It seeks to develop,
						 in each member of its organization, the ability and passion to work wisely, creatively and 
						 effectively for the betterment of humankind. It has a promise to impart futuristic technical 
						 education and instill higher values, making the students technologically superior and ethically 
						 strong.
						</p>
					</div>
				</div>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of Education</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers bachelors degree courses in 6 disciplines in Engineering viz. Computer Science and Engineering, Information Technology, Electronics and communication, Electrical and Electronics, Civil, Mechanical Engineering ,Biotechnology Engineering and 03  post graduate courses viz. M.Tech in Computer Science, M.Tech in Electronics and Master of Business Administration (MBA). The Institute has facilities for doctoral research in Computer Science and Electronics. 
					</p>
				</div>
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/directorsir.jpeg" alt="">
						<h6> DR.S.K.AGRAWAL</h6>
						<p>DIRECTOR (BIET LUCKNOW)</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/hodsir.jpeg" alt="">
						<h6>DR. C.L.P.GUPTA</h6>
						<p>HOD CSE Department </p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/mauryasir.jpeg" alt="">
						<h6> MR. S.K. MAURYA</h6>
						<p>Assistent Professor (CSE DEPT.)</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>BIET, LUCKNOW
							<span>SITAPUR ROAD UTTAR PRADESH INDIA</span>
						</p>
					</div>
					<div class="phone">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Bansal Institue Of Engineering  And Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2022 BIET | Developed by Adarsh Singh,Himanshu Shukla
              <a href="http://znumerique.azurewebsites.net" target="_parent">BIET LUCKNOW</a>
					</p>
				</div>
