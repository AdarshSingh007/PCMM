	...
	<div class="mail">
		...
		<div class="container">
			<div class="map footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<iframe src="https://maps.googleapis.com/maps/api/js?key=26.9423459,80.924586,17z/data=!3m1!4b1!4m5!3m4!1s0x399957e00ca6992d:0x3e09558f651ae573!8m2!3d26.9423459!4d80.92678?hl=en&authuser=0&callback=initMap&v=weekly"
				</div>
				</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Bansal Institute Of Engineering And Technology </h4>
					<p>Sitapur Road ,
					...
					<p>Telephone: +91 830-1979790/223365
						...
						E-mail: <a href="mailto:Adarshbiet07@gmail.com">Adarshbiet07@gmail.com</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>BIET 
							<span>SITAPUR ROAD LUCKNOW UP INDIA </span>
						</p>
					</div>
					<div class="phone">
						<p>1234567890</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Bansal Institute Of Engineering And Technology </h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2022 BIET  | Developed by
              <a href="https://w3.bansaliet.in" target="_parent">Adarsh Singh </a>
				</div>
