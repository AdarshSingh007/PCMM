        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://w3.bansaliet.in">Bansal Institute Of Engineering And Technology</a>
                </div>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="page-scroll" href="../StudentProfile/index.php">Student Login</a>
                        </li>
                        <li>
			...
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						...
						<li>
							<a href="../StudentProfile/index.php">Student Login</a>
						</li>
						<li>
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>Bansal Institute Of Eng. & Tech </p>
					<p>Lucknow(Up) ,India</p>
					<p>83019-79790/221456</p>
					<a href="mailto:adarshbiet07@gmail.com">adarshbiet07@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; 2022 BIET LUCKNOW | Developed by
              <a href="https://w3.bansaliet.in/" target="_parent">Adarsh Singh,Himanshu Shukla</a>
				</div>
