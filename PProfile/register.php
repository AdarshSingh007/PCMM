...
<html lang="en">
	<head>
	    ...
	    <title>Placement Officer Register</title>
	...
	<body class="light-gray-bg">
		<div class="templatemo-content-widget templatemo-login-widget white-bg">
			<header class="text-center">
	          ...
	          <h1>Placement Officer Register </h1>
	        </header>
		...
		<div class="footer">
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
					<li>
							<a href="../finalproject/Placement--Management--System-master/PProfile/index.php">Home</a>
						</li>
						<li>
						...
						<li>
							<a href="../finalproject/Placement--Management--System-master/HODProfile/index.php">HOD Login</a>
						</li>
						<li>
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>BIET sitapur road </p>
					<p>Lucknow up India</p>
					<p>08138-223818/223365</p>
					<a href="mailto:adarshbiet07@mail.com">adarshbiet07@mail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<a href="../index.html"><img src="images/wds.png" alt=""/></a>
					<p>© 2022-24
						<a href="adarshbiet.com" >Adarsh Singh </a>
					</p>
				</div>
